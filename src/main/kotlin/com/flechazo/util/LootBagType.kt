...
enum class LootBagType(
    ...
    override fun asItem(): Item = when (this) {
        COMMON -> ModItems.COMMON_LOOT_BAG
        UNCOMMON -> ModItems.UNCOMMON_LOOT_BAG
        RARE -> ModItems.RARE_LOOT_BAG
        EPIC -> ModItems.EPIC_LOOT_BAG
        LEGENDARY -> ModItems.LEGENDARY_LOOT_BAG
        PATIENT -> ModItems.PATIENT_LOOT_BAG
        ARTIFICIAL -> ModItems.ARTIFICIAL_LOOT_BAG
        BACON -> ModItems.BACON_LOOT_BAG
    }
...
fun LootBagItem.asLootBagType(): LootBagType = when (this) {
    ModItems.COMMON_LOOT_BAG -> LootBagType.COMMON
    ModItems.UNCOMMON_LOOT_BAG -> LootBagType.UNCOMMON
    ModItems.RARE_LOOT_BAG -> LootBagType.RARE
    ModItems.EPIC_LOOT_BAG -> LootBagType.EPIC
    ModItems.LEGENDARY_LOOT_BAG -> LootBagType.LEGENDARY
    ModItems.PATIENT_LOOT_BAG -> LootBagType.PATIENT
    ModItems.ARTIFICIAL_LOOT_BAG -> LootBagType.ARTIFICIAL
    ModItems.BACON_LOOT_BAG -> LootBagType.BACON
